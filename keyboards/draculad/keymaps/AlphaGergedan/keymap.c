...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] =  LAYOUT(
        ...
        KC_Z,         KC_X,    KC_C,    KC_V,    KC_B,                                                 KC_N,             KC_M,    KC_COMM, KC_DOT,  MO(_SYMB),
                                                 XXXXXXX,                                              KC_MS_BTN3,
                                        XXXXXXX, KC_LGUI, LSFT_T(KC_SPC),    XXXXXXX, KC_LCTL, MO(_NUM)
    ),
    [_NUM] = LAYOUT(
        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        KC_TAB,  KC_ESC,  KC_GRV,  KC_MINS, KC_EQL,                       KC_SCLN, KC_QUOT, KC_LBRC, KC_RBRC, KC_BSLS,
        KC_VOLD, KC_VOLU, KC_MUTE, KC_LALT, XXXXXXX,                      XXXXXXX, KC_COMM, KC_DOT,  KC_SLSH, KC_BSPC,
                                            XXXXXXX,                      XXXXXXX,
                                   XXXXXXX, KC_LGUI, LSFT_T(KC_SPC),    XXXXXXX, KC_LCTL,  XXXXXXX
    ),
    [_SYMB] = LAYOUT(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                        KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,
        KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_BTN1,                      XXXXXXX, XXXXXXX, XXXXXXX, KC_F11,   KC_F12,
        XXXXXXX, XXXXXXX, KC_PGDN, KC_PGUP, XXXXXXX,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, XXXXXXX,
                                            XXXXXXX,                      XXXXXXX,
                                   XXXXXXX, KC_LGUI, LSFT_T(KC_SPC),    XXXXXXX, KC_LCTL,  XXXXXXX
    ),
    [_MUS] = LAYOUT(
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    ...
    // don't know what is the index for the left encoder
    // so we just put it here FIXME
    else if (index == 1) {
      if(clockwise) {
        tap_code(KC_WH_D);
      }
